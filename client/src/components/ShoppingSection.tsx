...
export function ShoppingSection() {
  ...
  return (
    <section className="py-24 bg-[#1a237e]/70 text-white" ref={containerRef}>
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-bold mb-6">
            ...
            has changed.{" "}
            <span className="text-[#e1ff80]">Has your marketing?</span>
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Reach new audiences and inspire purchases by partnering with content
            creators.
          </p>
        </motion.div>
              ...
              <div className="flex items-start gap-6 mb-16">
                ...
                <div className="flex-1">
                  ...
                  >
                    ...
                    <div className="h-80 flex md:justify-between flex-wrap gap-4">
                      <div>
                        <h4 className="text-4xl font-bold mb-6">
                          Introduce your brand.
                        </h4>
                        <p className="text-gray-300 mb-8 max-w-lg">
                          Social media is the #1 source for product discovery
                          for Gen Z and Millennials. Get in front of new
                          audiences by partnering with brand-aligned creators
                      ...
                      >
                        <div className="bg-black rounded-2xl overflow-hidden shadow-xl">
                          <div className="aspect-[9/16] relative bg-gray-900 h-96 w-full">
                            <img
